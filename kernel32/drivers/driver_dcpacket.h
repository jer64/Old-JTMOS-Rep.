...
typedef struct
{
        ...
        void *po1,*po2;
	//
	void *extension_wrapper_function;
}SREQ;
...
#define DEVICE_CMD_OPEN			0x16
#define DEVICE_CMD_CREAT		0x17
#define DEVICE_CMD_CLOSE		0x18
#define DEVICE_CMD_READ			0x19
#define DEVICE_CMD_WRITE		0x1A
#define DEVICE_CMD_LSEEK		0x1B
#define DEVICE_CMD_READDIR		0x1C
#define DEVICE_CMD_MKDIR		0x1D
#define DEVICE_CMD_UNLINK		0x1E
#define DEVICE_CMD_CHDIR		0x1F
#define DEVICE_CMD_GETCWD		0x20
#define DEVICE_CMD_MKFS			0x21
#define DEVICE_CMD_RMDIR		0x22
